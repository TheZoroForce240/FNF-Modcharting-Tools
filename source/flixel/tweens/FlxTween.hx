...
class FlxTween implements IFlxDestroyable
{
	 ...
	 *
	 * ```haxe
	 * FlxTween.bezierPathTween(Object, { x: [500,1000,500], y: [350,400,400,350]}, 2.0, { ease: easeFunction, onStart: onStart, onUpdate: onUpdate, onComplete: onComplete, type: ONESHOT });
	 * ```
	 *
	 * @param	Object		The object containing the properties to tween.
	 ...
	 * @since   4.2.0
	 */
	public static function bezierPathTween(Object:Dynamic, Values:Dynamic, Duration:Float = 1, ?Options:TweenOptions):BezierPathTween
		{
			return globalManager.bezierPathTween(Object, Values, Duration, Options);
		}

	/**
	 * BezierPathTween but this time with num!!. Minimum 2 points.
	 *
	 * ```haxe
	 * FlxTween.bezierPathNumTween([0,500,0], 2.0, { ease: easeFunction, onStart: onStart, onUpdate: onUpdate, onComplete: onComplete, type: ONESHOT });
	 * ```
	 *
	 * @param	Object		The object containing the properties to tween.
	 * @param	Values		An object containing key/value pairs of properties and the value as in array containing points. Tip: Use Math.Nan at the first point to use the object's original value!
	 ...
	 * @since   4.2.0
	 */
	public static function bezierPathNumTween(Points:Array<Float>, Duration:Float = 1, ?Options:TweenOptions,?TweenFunction:Float->Void):BezierPathNumTween
	{
